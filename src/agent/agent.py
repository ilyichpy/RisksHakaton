...
 
Проверь есть ли различия в персональных данных от разных банков в файле, но (не сравнивай текущее и предыдущее ФИО) и если отличия в персональных данных найдется, обязательно выведи какие различия ты нашел, а именно: какие именно разные значения фамилии, имени, отчества, даты рождения и паспорта ты обнаружил
